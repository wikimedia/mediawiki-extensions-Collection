...
$messages['azb'] = array(
	...
	'coll-download_as' => '$1 اولاراق اندیر',
	'coll-download_as_tooltip' => 'بو ویکی صحیفه‌سینین $1 نوسخه‌سینی اندیر',
	'coll-disable' => 'ایشدن سال',
	'coll-book_creator_disable' => 'کیتاب یارادانی ایشدن سال',
	'coll-book_creator_disable_tooltip' => 'کیتاب یارادانی ایشلتمگی دایاندیر',
	'coll-add_linked_article' => 'باغلانان ویکی صحیفه‌سینی کیتابینیزا آرتیرین',
	'coll-remove_linked_article' => 'باغلانان ویکی صحیفه‌سینی کیتابینیزدان سیلین',
	'coll-add_category' => 'بو بؤلمه‌نی کیتابینیزا آرتیرین',
	'coll-add_category_tooltip' => 'بوتون بو بؤلمه‌ده اولان ویکی صحیفه‌لرینی کیتابینیزا آرتیرین',
	'coll-add_this_page' => 'بو صحیفه‌نی کیتابینیزا آرتیرین',
	'coll-add_page_tooltip' => 'ایندیکی ویکی صحیفه‌سین کیتابینیزا آرتیرین',
	'coll-bookscategory' => 'کیتابلار',
	'coll-clear_collection' => 'کیتابی تمیزله',
	'coll-clear_collection_confirm' => 'دوغرودان کیتابینیزین بوتونلوکله تمیزلنمه‌سین ایستییرسینیزمی؟',
	'coll-clear_collection_tooltip' => 'ایندیکی کیتابینیزدان بوتون ویکی صحیفه‌لرینی سیلین',
	'coll-help' => 'یاردیم',
	'coll-help_tooltip' => 'کیتابلار یاراتماق اوچون یاردیم گؤستر',
	'coll-helppage' => 'Help:کیتابلار',
	'coll-load_collection' => 'کیتاب یوکله‌یین',
	'coll-load_collection_tooltip' => 'بو کیتابی فرض ائدیلن کیتابینیز اولا‌راق یوکله‌یین',
	'coll-n_pages' => '{{PLURAL:$1|بیر|$1}} صحیفه',
	'coll-printable_version_pdf' => 'پی‌دی‌اِف نوسخه‌سی',
	'coll-remove_this_page' => 'بو صحیفه‌نی کیتابینیزدان چیخاردین',
	'coll-remove_page_tooltip' => 'ایندیکی ویکی صحیفه‌سینی کیتابینیزدان چیخاردین',
	'coll-show_collection' => 'کیتابی گؤستر',
	'coll-show_collection_tooltip' => 'کیتابینیزی دییشدیرمک/اندیرمک/سیفاریش وئرمک اوچون تیکلایین',
	'coll-not_addable' => 'بو صحیفه آرتیریلانماز',
	'coll-make_suggestions' => 'صحیفه اؤنریله',
	'coll-make_suggestions_tooltip' => 'کیتابینیزداکی اولان صحیفه‌لره گؤره اؤنریلر گؤستر',
...
$messages['bg'] = array(
	...
	'coll-remove_linked_article' => 'Премахване на свързаната уикистраница от книгата',
...
$messages['br'] = array(
	...
	'coll-n_pages' => '$1 {{PLURAL:$1|pajenn}}',
...
$messages['fa'] = array(
	...
	'coll-download_as' => 'دریافت به‌صورت $1',
	'coll-download_as_tooltip' => 'یک نسخهٔ $1 از این صفحهٔ ویکی را دریافت کن',
	...
	'coll-show_collection_tooltip' => 'برای ویرایش/دریافت/سفارش کتاب خود کلیک کنید',
...
$messages['frr'] = array(
	...
	'coll-download_as_tooltip' => 'En $1-werjuun faan detdiar wiki-sidj deelloose',
	'coll-disable' => 'ufstel',
	...
	'coll-printable_version_pdf' => 'PDF-werjuun',
...
$messages['gd'] = array(
	...
	'coll-n_pages' => '$1 {{PLURAL:$1|duilleag|dhuilleag|duilleagan|duilleag}}',
 ...
 */
$messages['is'] = array(
	'coll-print_export' => 'Prenta/sækja',
	'coll-create_a_book' => 'Búa til bók',
	'coll-create_a_book_tooltip' => 'Stofna bók eða greinasafn',
	'coll-book_creator' => 'Bókaviðmót',
	'coll-download_as' => 'Sækja $1-skrá',
	'coll-download_as_tooltip' => 'Sækja $1-útgáfu þessarar síðu',
	'coll-disable' => 'afvirkja',
	'coll-book_creator_disable' => 'Afvirkja bókaviðmótið',
	'coll-book_creator_disable_tooltip' => 'Hætta að nota bókaviðmót',
	'coll-add_linked_article' => 'Bæta tengdri wiki síðu við bókina þína',
	'coll-remove_linked_article' => 'Fjarlægja tengda wiki síðu úr bókinni þinni',
	...
	'coll-add_page_tooltip' => 'Bæta núverandi wikisíðu við bókina þína',
	'coll-bookscategory' => 'Bækur',
	'coll-clear_collection' => 'Tæma bók',
	'coll-clear_collection_confirm' => 'Vilt þú örugglega tæma bókina?',
	'coll-clear_collection_tooltip' => 'Fjarlægja allar wikisíður úr bókinni þinni',
	'coll-help' => 'Hjálp',
	'coll-help_tooltip' => 'Sýna hjálp um stofnun bóka',
	'coll-helppage' => 'Help:Bækur',
	'coll-load_collection' => 'Hlaða bók',
	'coll-load_collection_tooltip' => 'Hlaða þessa bók sem núverandi bók',
	'coll-n_pages' => '$1 {{PLURAL:$1|síða|síður}}',
	...
	'coll-show_collection_tooltip' => 'Smelltu til þess að breyta/sækja/panta bókina þína',
	'coll-not_addable' => 'Mistókst að bæta þessari síðu við',
	'coll-make_suggestions' => 'Stinga upp á síðum',
...
$messages['ko'] = array(
	...
	'coll-clear_collection' => '책 지우기',
	'coll-clear_collection_confirm' => '책에 있는 내용을 완전히 지우겠습니까?',
	'coll-clear_collection_tooltip' => '책에 있는 문서 모두를 제거하기',
	'coll-help' => '도움말',
	...
	'coll-n_pages' => '{{PLURAL:$1|문서}} $1개',
	'coll-printable_version_pdf' => 'PDF 버전',
	'coll-remove_this_page' => '책에서 해당 페이지를 제거',
	'coll-remove_page_tooltip' => '책에서 현재 위키 문서를 제거',
...
$messages['lrc'] = array(
	...
	'coll-remove_linked_article' => 'ويكی بلگه لينك بيه د كتاوتو نه جاوه جا بكيد',
	'coll-add_category' => 'ای دسه نه د كتاو خوتو اضاف بكيد',
	'coll-add_category_tooltip' => 'ويكی بلگيا ای دسه نه د كتاوتو اضاف بكيد',
	'coll-add_this_page' => 'ای بلگه نه د كتاوتو اضاف بكيد',
	'coll-add_page_tooltip' => 'ويكی بلگه تازه نه د كتاوتو اضاف بكيد',
	'coll-bookscategory' => 'كتاويا',
	'coll-clear_collection' => 'پاك كردن كتاو',
	'coll-clear_collection_confirm' => 'آيا واقعن ميهايت كلا كتاوتو نه پاك بكيد',
	'coll-clear_collection_tooltip' => 'همه ويكی بلگيا نه د كتاو تازه تو جا وه جا بكيد',
	'coll-help' => 'هومياری',
	'coll-help_tooltip' => 'هومياری دباره كتاوسازی نه نشون بيه',
	'coll-helppage' => 'هومياری:كتاويا', # Fuzzy
	'coll-load_collection' => 'سواركرد كتاو',
	'coll-load_collection_tooltip' => 'ای  كتاو نه سواركرد بكيد سی كتاو تازه باو خوتو',
	'coll-n_pages' => '$1 {{PLURAL:$1|بلگه|بلگيا}}',
	'coll-printable_version_pdf' => 'نسقه پی دی اف',
	'coll-remove_this_page' => 'ورداشتن ای بلگه د كتاو تو',
	'coll-remove_page_tooltip' => 'ويكی بلگه تازه نه د كتاوتو جاوه جا بكيد',
	'coll-show_collection' => 'نشون دائن كتاو',
	'coll-show_collection_tooltip' => 'سی ويرايشت بپورنيت/گرتن/كتاوتو نه بهايت',
	'coll-not_addable' => 'ای بلگه نتونه اضافه با',
	'coll-make_suggestions' => 'بلگيا پيشنادی',
	'coll-make_suggestions_tooltip' => 'پئشناديايی كه د اساس بلگيا مئن كتاوتو نه نشون بيئت',
...
$messages['min'] = array(
	...
	'coll-download_as' => 'Unduah sabagai $1',
	'coll-download_as_tooltip' => 'Unduah sabagai $1 dari laman ko',
	'coll-disable' => '↓tutuik',
...
$messages['mr'] = array(
	...
	'coll-create_a_book' => 'ग्रंथ तयार करा',
	'coll-create_a_book_tooltip' => 'ग्रंथ बनवा अथवा पृष्ठांचे संकलन करा',
	'coll-book_creator' => 'ग्रंथ निर्माणक',
	'coll-download_as' => '$1 म्हणून उतरवा',
	'coll-download_as_tooltip' => 'ह्या विकी पानाची  $1 आवृत्ती उतरवा',
	'coll-disable' => 'अक्षम करा',
	'coll-book_creator_disable' => 'ग्रंथ निर्माणक अक्षम करा',
	'coll-book_creator_disable_tooltip' => 'ग्रंथ निर्माणकाचा वापर थांबवा',
	'coll-add_linked_article' => 'दुवा दिलेले विकी पान आपल्या ग्रंथात समाविष्ट करा',
	'coll-remove_linked_article' => 'दुव्यातील विकी पान आपल्या ग्रंथातून वगळा.',
	'coll-add_category' => 'ह्या वर्गाचा तुमच्या ग्रंथात समावेश करा',
	...
	'coll-load_collection' => 'ग्रंथाचे अपभारण करा',
	...
	'coll-show_collection_tooltip' => 'आपल्या ग्रंथाचे संपादन करण्यासाठी / आपला ग्रंथ उतरवण्यासाठी/ आपल्या ग्रंथाची मागणी नोंदवण्यासाठी येथे टिचका',
	'coll-not_addable' => 'हे पान जोडता येणार नाही',
...
$messages['nl'] = array(
	...
	'coll-printable_version_pdf' => 'Pdfversie',
...
$messages['pt'] = array(
	...
	'coll-book_creator_disable' => 'Desativar criador de livros',
...
$messages['th'] = array(
	...
	'coll-download_as' => 'ดาวน์โหลดเป็น $1',
...
$messages['ur'] = array(
	...
	'coll-disable' => 'غیر فعال',
	'coll-book_creator_disable' => 'کتاب ساز غیر فعال',
	'coll-book_creator_disable_tooltip' => 'کتاب ساز کا استعمال بند کریں',
	...
	'coll-help' => 'مدد',
	'coll-help_tooltip' => 'کتاب سازی سے متعلق معاونت دکھائیں',
